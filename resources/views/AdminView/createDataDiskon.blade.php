        ...
        <div class="container" style="text-transform: capitalize">
            <div class="row">
                <div class="col-md-12 mt-3">
                    <h3>Form Tambah Data Product Diskon</h3>
                ...
                <form method="post" action="{{ route('PostCreateDiskon') }}" enctype="multipart/form-data" id="myForm">
            @csrf
                ...
                <div class="form-group">
                <label for="product">Product Diskon</label>
