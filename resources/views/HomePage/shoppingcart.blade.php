                ...
                <div class="shoping__cart__table">
                    <table>
                        ...
                        <tbody>
                            ...
                            <tr data-id="{{ $id }}" data-session="cartdiskon">
                                <td data-th="Product">
                                    <img src="{{'storage/'. $details['gambar'] }}" width="100" height="100" class="img-responsive" />
                                </td>
                                <td>
                        ...
                        <tbody>
                            <tr>
                                <td colspan="5" class="text-right">
                                    <h6><strong>Total {{ $total1 + $total2 }} Rupiah</strong></h6>
                                </td>
                            </tr>
                            <tr>
                                <td colspan="5" class="text-right">
                                    <a href="{{ url('/gallery') }}" class="btn btn-warning"><i class="fa fa-angle-left"></i> Kembali Belanja</a>
